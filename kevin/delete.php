...
<body>
	...
	<div class="container" style="border-style: solid; border-color: red; background-color: #ffcbd1;height: 500px;">
		...
		<h2>Years of exp.: <?php echo $getUserByID['years_exp']; ?></h2>
		<h2>Computer Language: <?php echo $getUserByID['fave_comp_lang']; ?></h2>
		<h2>Nationality: <?php echo $getUserByID['nationality']; ?></h2>
		<h2>Job Title: <?php echo $getUserByID['job_title']; ?></h2>
